	...
	<p align="center"><big><big>
		...
		<input type="hidden" name="cep" value= "<?php echo $_POST['cep'];?>">
 		...
 		<div align="center"><center>
                        <p>Username: <input type="text" name="username" size="10" value=""></p>
 		</center></div>

		<div align="center"><center>
                        <p>Senha: <input type="password" name="senha" size="10" value=""></p>
		</center></div>
			
		<div align="center"><center>
                        <p>Confirme sua Senha: <input type="password" name="confirma_senha" size="10" value=""></p>
 		</center></div>
